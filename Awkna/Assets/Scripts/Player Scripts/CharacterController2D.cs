...
public class CharacterController2D : MonoBehaviour
{
    ...
    //variables for climbing the ladder
    ...
    public void Move(float horizontalMove, float verticalMove, bool crouch, bool jump)
    {
        ...
        //only control the player if grounded or airControl is turned on or if it's climbing
        ...
        {
            // ...move the character by finding the target velocity
            Vector3 verticalTargetVelocity = new Vector2(m_Rigidbody2D.velocity.x, verticalMove * 10f);
            // And then smoothing it out and applying it to the character
            m_Rigidbody2D.velocity = Vector3.SmoothDamp(m_Rigidbody2D.velocity, verticalTargetVelocity, ref m_Velocity, m_MovementSmoothing);

            //Set the characters gravity to 0, in order to make the player climb
